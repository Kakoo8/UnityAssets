...
public class Gyroscope : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //{
        //this.transform.position += new Vector3(acc.x, 0, 0);
        //}
        //transform.rotation = Quaternion.Euler(acc.x*10, acc.z * 10, acc.y * 10 );
        gyroC();
